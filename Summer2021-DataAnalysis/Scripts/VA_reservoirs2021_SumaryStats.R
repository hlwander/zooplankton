#### Zoop Summary code modified from DCR - Summer 2021 Density and Biomass in VA reservoirs
...
taxaOfInterest<-c("Daphniidae","Copepoda","Calanoida","Cladocera","Cyclopoida","Rotifera","Keratella","Kellicottia","Crustacea","nauplius","Ceriodaphnia","Daphnia","Bosmina","Gastropus","Collotheca","Conochilus","Conochiloides","Synchaeta","Trichocerca","Lepadella","Monostyla","Lecane","Hexarthra","Polyarthra","Asplanchna","Ascomorpha") #,"Holopedium" --> not observed
...
ZoopFinal$BiomassConcentration_ugpL<-ifelse(ZoopFinal$site_no=="BVR_trap" | ZoopFinal$site_no=="BVR_schind"| ZoopDensityCalcs$site_no=="FCR_schind", ZoopFinal$BiomassConcentration_ugpL <- ZoopFinal$TotalBiomass_ug / ZoopFinal$Volume_unadj,
  ifelse(substr(ZoopDensityCalcs$site_no,1,3)=="BVR" & ZoopDensityCalcs$DepthOfTow_m > 8, ZoopFinal$BiomassConcentration_ugpL <- ZoopFinal$TotalBiomass_ug *(1/0.035)/ ZoopFinal$Volume_L, #NetEfficiency2020[1]
