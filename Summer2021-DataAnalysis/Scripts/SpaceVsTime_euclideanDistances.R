...
zoop_sunrise1 <- zoop_avg[zoop_avg$order==1,]
zoop_sunrise2 <- zoop_avg[zoop_avg$order==2,]
zoop_sunrise3 <- zoop_avg[zoop_avg$order==3,]
zoop_sunrise4 <- zoop_avg[zoop_avg$order==4,]
zoop_noon <- zoop_avg[zoop_avg$order==5,]
zoop_sunset1 <- zoop_avg[zoop_avg$order==6,]
zoop_sunset2 <- zoop_avg[zoop_avg$order==7,]
zoop_sunset3 <- zoop_avg[zoop_avg$order==8,]
zoop_sunset4 <- zoop_avg[zoop_avg$order==9,]
zoop_midnight <- zoop_avg[zoop_avg$order==10,]
...
zoop_noon_dens <- zoop_noon[,c(grepl("mean",colnames(zoop_noon)))]
...
zoop_noon_dens_trans <- hellinger(zoop_noon_dens)
...
#time NMDS
NMDS_sunrise1_bray <- metaMDS(zoop_sunrise1_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunrise1_bray$stress

NMDS_sunrise2_bray <- metaMDS(zoop_sunrise2_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunrise2_bray$stress

NMDS_sunrise3_bray <- metaMDS(zoop_sunrise3_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunrise3_bray$stress

NMDS_sunrise4_bray <- metaMDS(zoop_sunrise4_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunrise4_bray$stress

NMDS_noon_bray <- metaMDS(zoop_noon_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_noon_bray$stress

NMDS_sunset1_bray <- metaMDS(zoop_sunset1_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunset1_bray$stress

NMDS_sunset2_bray <- metaMDS(zoop_sunset2_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunset2_bray$stress

NMDS_sunset3_bray <- metaMDS(zoop_sunset3_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunset3_bray$stress

NMDS_sunset4_bray <- metaMDS(zoop_sunset4_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
NMDS_sunset4_bray$stress

NMDS_midnight_bray <- metaMDS(zoop_midnight_dens_trans, distance='bray', k=4, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
...
zoop_noon_euc <- as.matrix(vegdist(NMDS_noon_bray$points, method='euclidean'))
...
noon_dist <- sum(zoop_noon_euc[1,2],zoop_noon_euc[2,3],zoop_noon_euc[3,4],zoop_noon_euc[4,5],
                 zoop_noon_euc[5,6],zoop_noon_euc[6,7],zoop_noon_euc[7,8],zoop_noon_euc[8,9],zoop_noon_euc[9,10])
...
msn1_dist <- sum(zoop_msn1_euc[1,2],zoop_msn1_euc[2,3],zoop_msn1_euc[3,4],zoop_msn1_euc[4,5],
                 ...
                 zoop_msn1_euc[17,18],zoop_msn1_euc[18,19],zoop_msn1_euc[19,20])
...
msn2_dist <- sum(zoop_msn2_euc[1,2],zoop_msn2_euc[2,3],zoop_msn2_euc[3,4],zoop_msn2_euc[4,5],
                 ...
                 zoop_msn2_euc[17,18],zoop_msn2_euc[18,19],zoop_msn2_euc[19,20])
...
msn3_dist <- sum(zoop_msn3_euc[1,2],zoop_msn3_euc[2,3],zoop_msn3_euc[3,4],zoop_msn3_euc[4,5],
                 ...
                 zoop_msn3_euc[17,18],zoop_msn3_euc[18,19],zoop_msn3_euc[19,20])
...
msn4_dist <- sum(zoop_msn4_euc[1,2],zoop_msn4_euc[2,3],zoop_msn4_euc[3,4],zoop_msn4_euc[4,5],
                 ...
                 zoop_msn4_euc[17,18],zoop_msn4_euc[18,19],zoop_msn4_euc[19,20])
...
msn5_dist <- sum(zoop_msn5_euc[1,2],zoop_msn5_euc[2,3],zoop_msn5_euc[3,4],zoop_msn5_euc[4,5],
                 ...
                 zoop_msn5_euc[17,18],zoop_msn5_euc[18,19],zoop_msn5_euc[19,20])
